...
describe('Criar processo simples com vinculação do tipo apensamento', function () {
  ...
  it('Protocolo -> Administrativo -> Processo -> Simples -> Vinculação -> Apensamento', function () {
