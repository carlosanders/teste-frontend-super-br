...
describe('Criar processo documento avulso com vinculação do tipo remissão', function () {
  ...
  let paramPessoa, 
      ...
      paramModalidadeVinculacaoProcesso = "REMISSÃO"
  ...
  it('Protocolo -> Administrativo -> Processo -> Documento Avulso -> Vinculação -> Remissão', function () {
