...
describe('Criar processo documento avulso com vinculação do tipo anexação', function () {
  ...
  let paramPessoa, 
      ...
      paramModalidadeVinculacaoProcesso,
      paramObservacaoVinculacao
      ...
      paramModalidadeVinculacaoProcesso = "ANEXAÇÃO"
      paramObservacaoVinculacao = "TESTE"
  ...
  it('Protocolo -> Administrativo -> Processo -> Documento Avulso -> Vinculação -> Anexação', function () {
    ...
    protocolo.completeClassificacao(paramClassificacao)
    protocolo.getTitulo().clear().type(paramTitulo)
    //descrição com erro pois está retornando dois objetos com o mesmo nome
    //protocolo.getDescricao().type("teste descrição")
    protocolo.completeSetorResponsavelDadosBasicos(paramOrgao)
    ...
    protocolo.completeModalidadeVinculacaoProcesso(paramModalidadeVinculacaoProcesso)
    protocolo.getCheckAnexacao().click()
    protocolo.getObservacaoVinculacao().type(paramObservacaoVinculacao)
