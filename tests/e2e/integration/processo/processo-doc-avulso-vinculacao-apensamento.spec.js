...
describe('Criar processo documento avulso com vinculação do tipo apensamento', function () {
  ...
  let paramPessoa, 
      ...
      paramModalidadeVinculacaoProcesso = "APENSAMENTO"
  ...
  it('Protocolo -> Administrativo -> Processo -> Documento Avulso -> Vinculação -> Apensamento', function () {
