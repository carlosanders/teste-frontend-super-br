...
export class CdkTipoRelatorioFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoRelatorio').value) {
            andXFilter['especieRelatorio.generoRelatorio.id'] = `eq:${this.form.get('generoRelatorio').value.id}`;
        }

        if (this.form.get('especieRelatorio').value) {
            andXFilter['especieRelatorio.id'] = `eq:${this.form.get('especieRelatorio').value.id}`;
        }
