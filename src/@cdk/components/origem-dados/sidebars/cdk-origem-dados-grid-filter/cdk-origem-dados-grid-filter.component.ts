...
@Component({
    selector: 'cdk-origem-dados-grid-filter',
    templateUrl: './cdk-origem-dados-grid-filter.component.html',
    styleUrls: ['./cdk-origem-dados-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkOrigemDadosGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-origem-dados-main-sidebar').close();
    }
