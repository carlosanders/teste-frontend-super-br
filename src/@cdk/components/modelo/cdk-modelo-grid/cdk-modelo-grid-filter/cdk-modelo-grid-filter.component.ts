...
export class CdkModeloGridFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.form.get('modalidadeModelo').valueChanges.subscribe(value => {
            if (value !== null) {
                if (typeof value === 'object' && value) {
                    this.filters = {
                        ...this.filters,
                        'modalidadeModelo.id': `eq:${value.id}`
                    };
                } else {
                    if (this.filters.hasOwnProperty('modalidadeModelo.id')) {
                        delete this.filters['modalidadeModelo.id'];
                    }
                }
            }
        });
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-modelo-main-sidebar').close();
    }
