...
@Component({
    selector: 'cdk-modelo-upload',
    templateUrl: './cdk-modelo-upload.component.html',
    styleUrls: ['./cdk-modelo-upload.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})

export class CdkModeloUploadComponent implements OnInit {
