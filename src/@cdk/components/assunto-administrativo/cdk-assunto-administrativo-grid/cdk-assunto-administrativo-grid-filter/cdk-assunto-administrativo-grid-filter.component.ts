...
@Component({
    ...
    templateUrl: './cdk-assunto-administrativo-grid-filter.component.html',
    styleUrls: ['./cdk-assunto-administrativo-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class CdkAssuntoAdministrativoGridFilterComponent implements OnInit {
