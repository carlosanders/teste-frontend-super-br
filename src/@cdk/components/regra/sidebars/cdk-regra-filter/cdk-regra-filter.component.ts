...
@Component({
    selector: 'cdk-regra-filter',
    templateUrl: './cdk-regra-filter.component.html',
    styleUrls: ['./cdk-regra-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkRegraFilterComponent implements OnInit {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-regra-filter').close();
    }
