...
@Component({
    selector: 'cdk-vinculacao-repositorio-grid-filter',
    templateUrl: './cdk-vinculacao-repositorio-grid-filter.component.html',
    styleUrls: ['./cdk-vinculacao-repositorio-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkVinculacaoRepositorioGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-vinculacao-repositorio-main-sidebar').close();
    }
