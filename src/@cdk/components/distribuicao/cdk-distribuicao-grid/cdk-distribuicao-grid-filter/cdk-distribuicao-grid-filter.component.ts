...
export class CdkDistribuicaoGridFilterComponent implements OnInit {
    ...
    constructor(
        ...
        this.form = this._formBuilder.group({
            'tarefa.especieTarefa.nome': [null]
        });
     ...
     */
    ngOnInit(): void {
        this.form.get('tarefa.especieTarefa.nome').valueChanges.subscribe(value => {
            this.selected.emit({'tarefa.especieTarefa.nome': `like:${value}%`});
        });
    }
