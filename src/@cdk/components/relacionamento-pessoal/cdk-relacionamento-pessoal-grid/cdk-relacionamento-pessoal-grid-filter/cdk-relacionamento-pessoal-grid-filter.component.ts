...
@Component({
    ...
    templateUrl: './cdk-relacionamento-pessoal-grid-filter.component.html',
    styleUrls: ['./cdk-relacionamento-pessoal-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class CdkRelacionamentoPessoalGridFilterComponent implements OnInit {
