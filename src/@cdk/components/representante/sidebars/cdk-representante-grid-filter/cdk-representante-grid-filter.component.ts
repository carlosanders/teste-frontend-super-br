...
@Component({
    selector: 'cdk-representante-grid-filter',
    templateUrl: './cdk-representante-grid-filter.component.html',
    styleUrls: ['./cdk-representante-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkRepresentanteGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-representante-main-sidebar').close();
    }
