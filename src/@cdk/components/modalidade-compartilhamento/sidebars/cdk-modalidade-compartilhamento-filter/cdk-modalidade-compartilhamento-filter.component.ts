...
import {CdkModalidadeCompartilhamentoFilterModule} from "./cdk-modalidade-compartilhamento-filter.module";

@Component({
    selector: 'cdk-modalidade-compartilhamento-filter',
    templateUrl: './cdk-modalidade-compartilhamento-filter.component.html',
    styleUrls: ['./cdk-modalidade-compartilhamento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeCompartilhamentoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-compartilhamento-filter').close();
    }
