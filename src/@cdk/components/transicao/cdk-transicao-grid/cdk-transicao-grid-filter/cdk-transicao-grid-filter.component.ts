...
export class CdkTransicaoGridFilterComponent implements OnInit {
    ...
    constructor(
        ...
        this.form = this._formBuilder.group({
            'modalidadeTransicao.valor': [null]
        });
     ...
     */
    ngOnInit(): void {
        this.form.get('modalidadeTransicao.valor').valueChanges.subscribe(value => {
            this.selected.emit({'modalidadeTransicao.valor': `like:${value}%`});
        });
    }
