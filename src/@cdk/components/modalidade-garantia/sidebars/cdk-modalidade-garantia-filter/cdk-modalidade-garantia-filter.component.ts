...
@Component({
    selector: 'cdk-modalidade-garantia-filter',
    templateUrl: './cdk-modalidade-garantia-filter.component.html',
    styleUrls: ['./cdk-modalidade-garantia-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeGarantiaFilterComponent implements OnInit {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-garantia-filter').close();
    }
