...
@Component({
    ...
    templateUrl: './cdk-desentranhamento-grid-filter.component.html',
    styleUrls: ['./cdk-desentranhamento-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkDesentranhamentoGridFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.form.get('juntada').valueChanges.subscribe(value => {
            if (value !== null) {
