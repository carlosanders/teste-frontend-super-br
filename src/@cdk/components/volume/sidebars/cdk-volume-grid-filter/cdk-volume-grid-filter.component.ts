...
@Component({
    selector: 'cdk-volume-grid-filter',
    templateUrl: './cdk-volume-grid-filter.component.html',
    styleUrls: ['./cdk-volume-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkVolumeGridFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.form.get('encerrado').valueChanges.subscribe(value => {
            if (value !== null) {
                this.filters = {
                    ...this.filters,
                    encerrado: `eq:${value}`
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-volume-main-sidebar').close();
    }
