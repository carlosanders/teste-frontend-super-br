...
@Component({
    selector: 'cdk-nome-grid-filter',
    templateUrl: './cdk-nome-grid-filter.component.html',
    styleUrls: ['./cdk-nome-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkNomeGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-nome-main-sidebar').close();
    }
