...
@Component({
    selector: 'cdk-vinculacao-documento-grid-filter',
    templateUrl: './cdk-vinculacao-documento-grid-filter.component.html',
    styleUrls: ['./cdk-vinculacao-documento-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkVinculacaoDocumentoGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-vinculacao-documento-main-sidebar').close();
    }
