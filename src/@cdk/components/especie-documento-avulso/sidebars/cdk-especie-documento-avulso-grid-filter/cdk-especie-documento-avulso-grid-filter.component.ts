...
export class CdkEspecieDocumentoAvulsoGridFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.form.get('generoDocumentoAvulso').valueChanges.subscribe(value => {
            if (value !== null) {
                if (typeof value === 'object' && value) {
                    this.filters = {
                        ...this.filters,
                        'generoDocumentoAvulso.id': `eq:${value.id}`
                    };
                } else {
                    if (this.filters.hasOwnProperty('generoDocumentoAvulso.id')) {
                        delete this.filters['generoDocumentoAvulso.id'];
                    }
                }
            }
        });
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-especie-documento-avulso-main-sidebar').close();
    }
