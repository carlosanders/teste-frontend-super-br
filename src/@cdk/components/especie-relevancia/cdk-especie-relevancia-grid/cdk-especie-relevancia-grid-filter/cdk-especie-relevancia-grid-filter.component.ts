...
@Component({
    selector: 'cdk-especie-relevancia-grid-filter',
    templateUrl: './cdk-especie-relevancia-grid-filter.component.html',
    styleUrls: ['./cdk-especie-relevancia-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkEspecieRelevanciaGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-especie-relevancia-main-sidebar').close();
    }
