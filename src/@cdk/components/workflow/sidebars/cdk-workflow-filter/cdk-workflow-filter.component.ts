...
export class CdkWorkflowFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.form.get('especieTarefaInicial').valueChanges.subscribe(value => {
            if (value !== null) {
                if (typeof value === 'object' && value) {
                    this.filters = {
                        ...this.filters,
                        'especieTarefaInicial.id': `eq:${value.id}`
                    };
                } else {
                    if (this.filters.hasOwnProperty('especieTarefaInicial.id')) {
                        delete this.filters['especieTarefaInicial.id'];
                    }
                }
            }
        });
