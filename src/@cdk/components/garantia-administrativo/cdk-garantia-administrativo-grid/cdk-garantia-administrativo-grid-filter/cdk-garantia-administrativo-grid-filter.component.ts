...
@Component({
    selector: 'cdk-garantia-administrativo-grid-filter',
    templateUrl: './cdk-garantia-administrativo-grid-filter.component.html',
    styleUrls: ['./cdk-garantia-administrativo-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class CdkGarantiaAdministrativoGridFilterComponent implements OnInit {
