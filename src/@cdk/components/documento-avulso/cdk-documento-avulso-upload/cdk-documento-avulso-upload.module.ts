...
import {CdkDocumentoAvulsoUploadComponent} from './cdk-documento-avulso-upload.component';
...
@NgModule({
    declarations: [
        CdkDocumentoAvulsoUploadComponent,
    ],
    imports: [
...
export class CdkDocumentoAvulsoUploadModule {
}
