...
@Component({
    ...
    templateUrl: './cdk-documento-avulso-upload.component.html',
    styleUrls: ['./cdk-documento-avulso-upload.component.scss'],
...
export class CdkDocumentoAvulsoUploadComponent implements OnInit, OnChanges, OnDestroy {
