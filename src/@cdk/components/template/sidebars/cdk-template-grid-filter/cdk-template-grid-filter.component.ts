...
@Component({
    selector: 'cdk-template-grid-filter',
    templateUrl: './cdk-template-grid-filter.component.html',
    styleUrls: ['./cdk-template-grid-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkTemplateGridFilterComponent implements OnInit {
    ...
    buscar(): void {
        this.emite();
        this._cdkSidebarService.getSidebar('cdk-template-main-sidebar').close();
    }
