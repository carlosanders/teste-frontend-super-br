...
import {Relatorio, Pagination} from '@cdk/models';
...
@Component({
    selector: 'relatorio-view-main-sidebar',
...
export class RelatorioViewMainSidebarComponent implements OnInit {
    ...
    constructor(
        ...
        this._store
            ...
            if (routerState) {
                ...
                this.volumePaginaton.filter = {'relatorio.id': 'eq:' + this.routerState.params.relatorioHandle};
            }
        });

        const path = 'app/main/apps/relatorios/relatorio-view/sidebars/main';
    ...
    gotoStep(step, ativo): void {
        if (this.relatorios[this.currentStep.step] === undefined || !ativo) {
            return;
        }
