...
@Injectable()
export class ModeloAnexoEffect {
    routerState: any;
    ...
    getModelo: any =
        this._actions
            .pipe(
                ofType<ModeloAnexoActions.GetModelo>(ModeloAnexoActions.GET_MODELO),
                switchMap((action) => {
                ...
                switchMap(response => [
                    ...
                    new ModeloAnexoActions.GetModeloSuccess({
                        loaded: {
                            id: 'modeloHandle',
                ...
                catchError((err, caught) => {
                    console.log(err);
                    this._store.dispatch(new ModeloAnexoActions.GetModeloFailed(err));
                    return caught;
                })
            );
    ...
    saveModelo: any =
        this._actions
            .pipe(
                ofType<ModeloAnexoActions.SaveModelo>(ModeloAnexoActions.SAVE_MODELO),
                switchMap((action) => {
                    return this._modeloService.save(action.payload).pipe(
                        mergeMap((response: Modelo) => [
                            new ModeloAnexoActions.SaveModeloSuccess(),
                ...
                catchError((err, caught) => {
                    console.log(err);
                    this._store.dispatch(new ModeloAnexoActions.SaveModeloFailed(err));
                    return caught;
                })
            );
    ...
    saveModeloSuccess: any =
        this._actions
            .pipe(
                ofType<ModeloAnexoActions.SaveModeloSuccess>(ModeloAnexoActions.SAVE_MODELO_SUCCESS),
                tap(() => {
