...
import * as EspecieSetorListActions from '../../../especie-setor-list/store/actions';
    ...
    saveEspecieSetor: any =
        this._actions
            .pipe(
                ...
                switchMap((action) => {
                    return this._especieSetorService.save(action.payload).pipe(
                        mergeMap((response: EspecieSetor) => [
                            new EspecieSetorEditActions.SaveEspecieSetorSuccess(),
