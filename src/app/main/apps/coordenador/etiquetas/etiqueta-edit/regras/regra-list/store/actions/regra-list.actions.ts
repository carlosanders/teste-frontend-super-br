...
export const GET_REGRAS = '[COORDENADOR REGRA LIST] GET REGRAS';
export const GET_REGRAS_SUCCESS = '[COORDENADOR REGRA LIST] GET REGRAS SUCCESS';
export const GET_REGRAS_FAILED = '[COORDENADOR REGRA LIST] GET REGRAS FAILED';

export const RELOAD_REGRAS = '[COORDENADOR REGRA LIST] RELOAD REGRAS';

export const DELETE_REGRA = '[COORDENADOR REGRA LIST] DELETE REGRA';
export const DELETE_REGRA_SUCCESS = '[COORDENADOR REGRA LIST] DELETE REGRA SUCCESS';
export const DELETE_REGRA_FAILED = '[COORDENADOR REGRA LIST] DELETE REGRA FAILED';
