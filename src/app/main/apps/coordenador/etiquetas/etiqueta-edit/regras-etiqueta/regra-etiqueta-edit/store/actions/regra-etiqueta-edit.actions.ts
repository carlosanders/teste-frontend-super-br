...
export const CREATE_REGRA_ETIQUETA = '[REGRA] CREATE REGRA ETIQUETA COORDENADOR ';
export const CREATE_REGRA_ETIQUETA_SUCCESS = '[REGRA] CREATE REGRA ETIQUETA COORDENADOR  SUCCESS';

export const SAVE_REGRA_ETIQUETA = '[REGRA] SAVE REGRA ETIQUETA COORDENADOR ';
export const SAVE_REGRA_ETIQUETA_SUCCESS = '[REGRA] SAVE REGRA ETIQUETA COORDENADOR SUCCESS';
export const SAVE_REGRA_ETIQUETA_FAILED = '[REGRA] SAVE REGRA ETIQUETA COORDENADOR FAILED';

export const GET_REGRA_ETIQUETA = '[REGRA] GET REGRA COORDENADOR ETIQUETA';
export const GET_REGRA_ETIQUETA_SUCCESS = '[REGRA] GET REGRA ETIQUETA COORDENADOR SUCCESS';
export const GET_REGRA_ETIQUETA_FAILED = '[REGRA] GET REGRA ETIQUETA COORDENADOR FAILED';
