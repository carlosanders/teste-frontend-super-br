...
export const GET_ACOES = '[COORDENADOR ACAO LIST] GET ACOES';
export const GET_ACOES_SUCCESS = '[COORDENADOR ACAO LIST] GET ACOES SUCCESS';
export const GET_ACOES_FAILED = '[COORDENADOR ACAO LIST] GET ACOES FAILED';

export const RELOAD_ACOES = '[COORDENADOR ACAO LIST] RELOAD ACOES';

export const DELETE_ACAO = '[COORDENADOR ACAO LIST] DELETE ACAO';
export const DELETE_ACAO_SUCCESS = '[COORDENADOR ACAO LIST] DELETE ACAO SUCCESS';
export const DELETE_ACAO_FAILED = '[COORDENADOR ACAO LIST] DELETE ACAO FAILED';
