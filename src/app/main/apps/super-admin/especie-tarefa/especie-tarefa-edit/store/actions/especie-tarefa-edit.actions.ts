...
export const CREATE_ESPECIE_TAREFA = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] CREATE ESPECIE_TAREFA';
export const CREATE_ESPECIE_TAREFA_SUCCESS = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] CREATE ESPECIE_TAREFA SUCCESS';

export const SAVE_ESPECIE_TAREFA = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE ESPECIE_TAREFA';
export const SAVE_ESPECIE_TAREFA_SUCCESS = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE ESPECIE_TAREFA SUCCESS';
export const SAVE_ESPECIE_TAREFA_FAILED = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE ESPECIE_TAREFA FAILED';

export const UPDATE_ESPECIE_TAREFA = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] UPDATE ESPECIE_TAREFA';
export const UPDATE_ESPECIE_TAREFA_SUCCESS = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] UPDATE ESPECIE_TAREFA SUCCESS';
export const UPDATE_ESPECIE_TAREFA_FAILED = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] UPDATE ESPECIE_TAREFA FAILED';

export const GET_ESPECIE_TAREFA = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] GET ESPECIE_TAREFA';
export const GET_ESPECIE_TAREFA_SUCCESS = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] GET ESPECIE_TAREFA SUCCESS';
export const GET_ESPECIE_TAREFA_FAILED = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] GET ESPECIE_TAREFA FAILED';

export const SAVE_COLABORADOR = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE COLABORADOR';
export const SAVE_COLABORADOR_SUCCESS = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE COLABORADOR SUCCESS';
export const SAVE_COLABORADOR_FAILED = '[SUPER-ADMIN ESPECIE_TAREFA EDIT] SAVE COLABORADOR FAILED';
