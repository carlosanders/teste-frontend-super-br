...
export const CREATE_ESPECIE_RELEVANCIA = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] CREATE ESPECIE_RELEVANCIA';
export const CREATE_ESPECIE_RELEVANCIA_SUCCESS = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] CREATE ESPECIE_RELEVANCIA SUCCESS';

export const SAVE_ESPECIE_RELEVANCIA = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] SAVE ESPECIE_RELEVANCIA';
export const SAVE_ESPECIE_RELEVANCIA_SUCCESS = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] SAVE ESPECIE_RELEVANCIA SUCCESS';
export const SAVE_ESPECIE_RELEVANCIA_FAILED = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] SAVE ESPECIE_RELEVANCIA FAILED';

export const UPDATE_ESPECIE_RELEVANCIA = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] UPDATE ESPECIE_RELEVANCIA';
export const UPDATE_ESPECIE_RELEVANCIA_SUCCESS = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] UPDATE ESPECIE_RELEVANCIA SUCCESS';
export const UPDATE_ESPECIE_RELEVANCIA_FAILED = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] UPDATE ESPECIE_RELEVANCIA FAILED';

export const GET_ESPECIE_RELEVANCIA = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] GET ESPECIE_RELEVANCIA';
export const GET_ESPECIE_RELEVANCIA_SUCCESS = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] GET ESPECIE_RELEVANCIA SUCCESS';
export const GET_ESPECIE_RELEVANCIA_FAILED = '[SUPER-ADMIN ESPECIE_RELEVANCIA EDIT] GET ESPECIE_RELEVANCIA FAILED';
