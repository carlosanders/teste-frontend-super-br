...
export const CREATE_UNIDADE = '[SUPER-ADMIN UNIDADE EDIT] CREATE UNIDADE';
export const CREATE_UNIDADE_SUCCESS = '[SUPER-ADMIN UNIDADE EDIT] CREATE UNIDADE SUCCESS';

export const SAVE_UNIDADE = '[SUPER-ADMIN UNIDADE EDIT] SAVE UNIDADE';
export const SAVE_UNIDADE_SUCCESS = '[SUPER-ADMIN UNIDADE EDIT] SAVE UNIDADE SUCCESS';
export const SAVE_UNIDADE_FAILED = '[SUPER-ADMIN UNIDADE EDIT] SAVE UNIDADE FAILED';

export const GET_UNIDADE = '[SUPER-ADMIN UNIDADE EDIT] GET UNIDADE';
export const GET_UNIDADE_SUCCESS = '[SUPER-ADMIN UNIDADE EDIT] GET UNIDADE SUCCESS';
export const GET_UNIDADE_FAILED = '[SUPER-ADMIN UNIDADE EDIT] GET UNIDADE FAILED';
