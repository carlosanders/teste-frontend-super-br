...
export const GET_UNIDADES = '[SUPER-ADMIN UNIDADES LIST] GET UNIDADES';
export const GET_UNIDADES_SUCCESS = '[SUPER-ADMIN UNIDADES LIST] GET UNIDADES SUCCESS';
export const GET_UNIDADES_FAILED = '[SUPER-ADMIN UNIDADES LIST] GET UNIDADES FAILED';

export const RELOAD_UNIDADES = '[SUPER-ADMIN UNIDADES LIST] RELOAD UNIDADES';
