...
export const GET_COMPETENCIAS = '[SUPER-ADMIN COMPETENCIAS LIST] GET COMPETENCIAS';
export const GET_COMPETENCIAS_SUCCESS = '[SUPER-ADMIN COMPETENCIAS LIST] GET COMPETENCIAS SUCCESS';
export const GET_COMPETENCIAS_FAILED = '[SUPER-ADMIN COMPETENCIAS LIST] GET COMPETENCIAS FAILED';

export const DELETE_COMPETENCIA = '[SUPER-ADMIN COMPETENCIA LIST] DELETE COMPETENCIA';
export const DELETE_COMPETENCIA_SUCCESS = '[SUPER-ADMIN COMPETENCIA LIST] DELETE COMPETENCIA SUCCESS';
export const DELETE_COMPETENCIA_FAILED = '[SUPER-ADMIN COMPETENCIA LIST] DELETE COMPETENCIA FAILED';

export const RELOAD_COMPETENCIAS = '[SUPER-ADMIN COMPETENCIAS LIST] RELOAD COMPETENCIAS';
