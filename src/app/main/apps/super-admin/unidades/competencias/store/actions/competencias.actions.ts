...
export const GET_UNIDADE = '[SUPER-ADMIN COMPETENCIAS] GET UNIDADE';
export const GET_UNIDADE_SUCCESS = '[SUPER-ADMIN COMPETENCIAS] GET UNIDADE SUCCESS';
export const GET_UNIDADE_FAILED = '[SUPER-ADMIN COMPETENCIAS] GET UNIDADE FAILED';
