...
export const CREATE_COMPETENCIA = '[SUPER-ADMIN COMPETENCIA EDIT] CREATE COMPETENCIA';
export const CREATE_COMPETENCIA_SUCCESS = '[SUPER-ADMIN COMPETENCIA EDIT] CREATE COMPETENCIA SUCCESS';

export const SAVE_COMPETENCIA = '[SUPER-ADMIN COMPETENCIA EDIT] SAVE COMPETENCIA';
export const SAVE_COMPETENCIA_SUCCESS = '[SUPER-ADMIN COMPETENCIA EDIT] SAVE COMPETENCIA SUCCESS';
export const SAVE_COMPETENCIA_FAILED = '[SUPER-ADMIN COMPETENCIA EDIT] SAVE COMPETENCIA FAILED';

export const GET_COMPETENCIA = '[SUPER-ADMIN COMPETENCIA EDIT] GET COMPETENCIA';
export const GET_COMPETENCIA_SUCCESS = '[SUPER-ADMIN COMPETENCIA EDIT] GET COMPETENCIA SUCCESS';
export const GET_COMPETENCIA_FAILED = '[SUPER-ADMIN COMPETENCIA EDIT] GET COMPETENCIA FAILED';
