...
export const GET_LOCALIZADORES = '[SUPER-ADMIN LOCALIZADORES LIST] GET LOCALIZADORES';
export const GET_LOCALIZADORES_SUCCESS = '[SUPER-ADMIN LOCALIZADORES LIST] GET LOCALIZADORES SUCCESS';
export const GET_LOCALIZADORES_FAILED = '[SUPER-ADMIN LOCALIZADORES LIST] GET LOCALIZADORES FAILED';

export const RELOAD_LOCALIZADORES = '[SUPER-ADMIN LOCALIZADORES LIST] RELOAD LOCALIZADORES';

export const DELETE_LOCALIZADOR = '[SUPER-ADMIN LOCALIZADORES LIST] DELETE LOCALIZADOR';
export const DELETE_LOCALIZADOR_SUCCESS = '[SUPER-ADMIN LOCALIZADORES LIST] DELETE LOCALIZADOR SUCCESS';
export const DELETE_LOCALIZADOR_FAILED = '[SUPER-ADMIN LOCALIZADORES LIST] DELETE LOCALIZADOR FAILED';
