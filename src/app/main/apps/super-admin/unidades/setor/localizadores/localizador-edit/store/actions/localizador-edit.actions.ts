...
export const CREATE_LOCALIZADOR = '[SUPER-ADMIN LOCALIZADOR EDIT] CREATE LOCALIZADOR';
export const CREATE_LOCALIZADOR_SUCCESS = '[SUPER-ADMIN LOCALIZADOR EDIT] CREATE LOCALIZADOR SUCCESS';

export const SAVE_LOCALIZADOR = '[SUPER-ADMIN LOCALIZADOR EDIT] SAVE LOCALIZADOR';
export const SAVE_LOCALIZADOR_SUCCESS = '[SUPER-ADMIN LOCALIZADOR EDIT] SAVE LOCALIZADOR SUCCESS';
export const SAVE_LOCALIZADOR_FAILED = '[SUPER-ADMIN LOCALIZADOR EDIT] SAVE LOCALIZADOR FAILED';

export const GET_LOCALIZADOR = '[SUPER-ADMIN LOCALIZADOR EDIT] GET LOCALIZADOR';
export const GET_LOCALIZADOR_SUCCESS = '[SUPER-ADMIN LOCALIZADOR EDIT] GET LOCALIZADOR SUCCESS';
export const GET_LOCALIZADOR_FAILED = '[SUPER-ADMIN LOCALIZADOR EDIT] GET LOCALIZADOR FAILED';
