...
export const CREATE_LOTACAO = '[SUPER-ADMIN LOTACAO EDIT] CREATE LOTACAO';
export const CREATE_LOTACAO_SUCCESS = '[SUPER-ADMIN LOTACAO EDIT] CREATE LOTACAO SUCCESS';

export const SAVE_LOTACAO = '[SUPER-ADMIN LOTACAO EDIT] SAVE LOTACAO';
export const SAVE_LOTACAO_SUCCESS = '[SUPER-ADMIN LOTACAO EDIT] SAVE LOTACAO SUCCESS';
export const SAVE_LOTACAO_FAILED = '[SUPER-ADMIN LOTACAO EDIT] SAVE LOTACAO FAILED';

export const GET_LOTACAO = '[SUPER-ADMIN LOTACAO EDIT] GET LOTACAO';
export const GET_LOTACAO_SUCCESS = '[SUPER-ADMIN LOTACAO EDIT] GET LOTACAO SUCCESS';
export const GET_LOTACAO_FAILED = '[SUPER-ADMIN LOTACAO EDIT] GET LOTACAO FAILED';
