...
export const GET_SETOR = '[SUPER-ADMIN LOTACOES] GET SETOR';
export const GET_SETOR_SUCCESS = '[SUPER-ADMIN LOTACOES] GET SETOR SUCCESS';
export const GET_SETOR_FAILED = '[SUPER-ADMIN LOTACOES] GET SETOR FAILED';
