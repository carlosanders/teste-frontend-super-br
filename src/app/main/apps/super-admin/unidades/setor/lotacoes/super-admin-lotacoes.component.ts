...
@Component({
    selector: 'root-lotacoes',
    templateUrl: './super-admin-lotacoes.component.html',
    styleUrls: ['./super-admin-lotacoes.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class SuperAdminLotacoesComponent implements OnInit, OnDestroy {
