...
export const CREATE_SETOR = '[SUPER-ADMIN SETOR EDIT] CREATE SETOR';
export const CREATE_SETOR_SUCCESS = '[SUPER-ADMIN SETOR EDIT] CREATE SETOR SUCCESS';

export const SAVE_SETOR = '[SUPER-ADMIN SETOR EDIT] SAVE SETOR';
export const SAVE_SETOR_SUCCESS = '[SUPER-ADMIN SETOR EDIT] SAVE SETOR SUCCESS';
export const SAVE_SETOR_FAILED = '[SUPER-ADMIN SETOR EDIT] SAVE SETOR FAILED';

export const GET_SETOR = '[SUPER-ADMIN SETOR EDIT] GET SETOR';
export const GET_SETOR_SUCCESS = '[SUPER-ADMIN SETOR EDIT] GET SETOR SUCCESS';
export const GET_SETOR_FAILED = '[SUPER-ADMIN SETOR EDIT] GET SETOR FAILED';
