...
export const CREATE_VINCULACAO_PESSOA_USUARIO = '[SUPER-ADMIN VINCULACAO_PESSOA_USUARIO EDIT] CREATE VINCULACAO_PESSOA_USUARIO';
export const CREATE_VINCULACAO_PESSOA_USUARIO_SUCCESS = '[SUPER-ADMIN VINCULACAO_PESSOA_USUARIO EDIT] CREATE VINCULACAO_PESSOA_USUARIO SUCCESS';

export const SAVE_VINCULACAO_PESSOA_USUARIO = '[SUPER-ADMIN VINCULACAO_PESSOA_USUARIO EDIT] SAVE VINCULACAO_PESSOA_USUARIO';
export const SAVE_VINCULACAO_PESSOA_USUARIO_SUCCESS = '[SUPER-ADMIN VINCULACAO_PESSOA_USUARIO EDIT] SAVE VINCULACAO_PESSOA_USUARIO SUCCESS';
export const SAVE_VINCULACAO_PESSOA_USUARIO_FAILED = '[SUPER-ADMIN VINCULACAO_PESSOA_USUARIO EDIT] SAVE VINCULACAO_PESSOA_USUARIO FAILED';
