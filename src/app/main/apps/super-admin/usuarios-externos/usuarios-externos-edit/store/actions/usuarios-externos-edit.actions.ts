...
export const SAVE_USUARIOS_EXTERNOS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] SAVE USUARIOS_EXTERNOS';
export const SAVE_USUARIOS_EXTERNOS_SUCCESS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] SAVE USUARIOS_EXTERNOS SUCCESS';
export const SAVE_USUARIOS_EXTERNOS_FAILED = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] SAVE USUARIOS_EXTERNOS FAILED';

export const UPDATE_USUARIOS_EXTERNOS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] UPDATE USUARIOS_EXTERNOS';
export const UPDATE_USUARIOS_EXTERNOS_SUCCESS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] UPDATE USUARIOS_EXTERNOS SUCCESS';
export const UPDATE_USUARIOS_EXTERNOS_FAILED = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] UPDATE USUARIOS_EXTERNOS FAILED';

export const GET_USUARIOS_EXTERNOS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] GET USUARIOS_EXTERNOS';
export const GET_USUARIOS_EXTERNOS_SUCCESS = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] GET USUARIOS_EXTERNOS SUCCESS';
export const GET_USUARIOS_EXTERNOS_FAILED = '[SUPER-ADMIN USUARIOS_EXTERNOS EDIT] GET USUARIOS_EXTERNOS FAILED';
