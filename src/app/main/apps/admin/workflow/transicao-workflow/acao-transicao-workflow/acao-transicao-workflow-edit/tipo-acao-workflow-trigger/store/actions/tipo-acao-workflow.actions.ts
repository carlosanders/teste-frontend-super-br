...
export const GET_TIPO_ACAO_WORKFLOW = '[TIPO ACAO WORKFLOW] GET TIPO ACAO WORKFLOW';
export const GET_TIPO_ACAO_WORKFLOW_SUCCESS = '[TIPO ACAO WORKFLOW] GET TIPO ACAO WORKFLOW SUCCESS';
export const GET_TIPO_ACAO_WORKFLOW_FAILED = '[TIPO ACAO WORKFLOW] GET TIPO ACAO WORKFLOW FAILED';
