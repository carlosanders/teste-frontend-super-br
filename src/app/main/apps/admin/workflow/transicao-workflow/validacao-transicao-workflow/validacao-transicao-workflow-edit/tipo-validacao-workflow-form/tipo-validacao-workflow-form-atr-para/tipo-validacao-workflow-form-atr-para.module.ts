...
const path = 'app/main/apps/admin/workflows/transicao-workflow/validacao-transicao-workflow/validacao-transicao-workflow-edit/tipo-validacao-workflow-form/tipo-validacao-workflow-form-atr-para';
