...
export const GET_TIPO_VALIDACAO_WORKFLOW = '[TIPO ACAO WORKFLOW EDIT] GET TIPO ACAO WORKFLOW';
export const GET_TIPO_VALIDACAO_WORKFLOW_SUCCESS = '[TIPO ACAO WORKFLOW EDIT] GET TIPO ACAO WORKFLOW SUCCESS';
export const GET_TIPO_VALIDACAO_WORKFLOW_FAILED = '[TIPO ACAO WORKFLOW EDIT] GET TIPO ACAO WORKFLOW FAILED';
