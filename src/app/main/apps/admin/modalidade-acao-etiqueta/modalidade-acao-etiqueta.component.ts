...
@Component({
    selector: 'modalidade-acao-etiqueta',
    templateUrl: './modalidade-acao-etiqueta.component.html',
    styleUrls: ['./modalidade-acao-etiqueta.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class ModalidadeAcaoEtiquetaComponent implements OnInit, OnDestroy {
