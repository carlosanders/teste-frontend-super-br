...
@Injectable()
export class LocalizadorEffects {
    routerState: any;
    ...
    getSetor: any =
        this._actions
            .pipe(
                ofType<LocalizadorActions.GetSetor>(LocalizadorActions.GET_SETOR),
                switchMap((action) => {
                ...
                switchMap(response => [
                    ...
                    new LocalizadorActions.GetSetorSuccess({
                        loaded: {
                            id: 'setorHandle',
                ...
                catchError((err, caught) => {
                    console.log(err);
                    this._store.dispatch(new LocalizadorActions.GetSetorFailed(err));
                    return caught;
                })
            );
}
