...
export const GET_LOCALIZADORES = '[LOCALIZADOR LIST] GET LOCALIZADORES';
export const GET_LOCALIZADORES_SUCCESS = '[LOCALIZADOR LIST] GET LOCALIZADORES SUCCESS';
export const GET_LOCALIZADORES_FAILED = '[LOCALIZADOR LIST] GET LOCALIZADORES FAILED';

export const RELOAD_LOCALIZADORES = '[LOCALIZADOR LIST] RELOAD LOCALIZADORES';

export const DELETE_LOCALIZADOR = '[LOCALIZADOR LIST] DELETE LOCALIZADOR';
export const DELETE_LOCALIZADOR_SUCCESS = '[LOCALIZADOR LIST] DELETE LOCALIZADOR SUCCESS';
export const DELETE_LOCALIZADOR_FAILED = '[LOCALIZADOR LIST] DELETE LOCALIZADOR FAILED';
