...
export const GET_LOCALIZADORES = '[ADMIN LOCALIZADOR LIST] GET LOCALIZADORES';
export const GET_LOCALIZADORES_SUCCESS = '[ADMIN LOCALIZADOR LIST] GET LOCALIZADORES SUCCESS';
export const GET_LOCALIZADORES_FAILED = '[ADMIN LOCALIZADOR LIST] GET LOCALIZADORES FAILED';

export const RELOAD_LOCALIZADORES = '[ADMIN LOCALIZADOR LIST] RELOAD LOCALIZADORES';

export const DELETE_LOCALIZADOR = '[ADMIN LOCALIZADOR LIST] DELETE LOCALIZADOR';
export const DELETE_LOCALIZADOR_SUCCESS = '[ADMIN LOCALIZADOR LIST] DELETE LOCALIZADOR SUCCESS';
export const DELETE_LOCALIZADOR_FAILED = '[ADMIN LOCALIZADOR LIST] DELETE LOCALIZADOR FAILED';

export const SAVE_LOCALIZADOR = '[ADMIN LOCALIZADOR] SAVE LOCALIZADOR';
export const SAVE_LOCALIZADOR_SUCCESS = '[ADMIN LOCALIZADOR] SAVE LOCALIZADOR SUCCESS';
export const SAVE_LOCALIZADOR_FAILED = '[ADMIN LOCALIZADOR] SAVE LOCALIZADOR FAILED';
