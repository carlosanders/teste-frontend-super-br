...
export const GET_NUMEROS_UNICOS_DOCUMENTOS = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] GET NUMEROS UNICOS DOCUMENTOS';
export const GET_NUMEROS_UNICOS_DOCUMENTOS_SUCCESS = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] GET NUMEROS UNICOS DOCUMENTOS SUCCESS';
export const GET_NUMEROS_UNICOS_DOCUMENTOS_FAILED = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] GET NUMEROS UNICOS DOCUMENTOS FAILED';

export const RELOAD_NUMEROS_UNICOS_DOCUMENTOS = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] RELOAD NUMEROS UNICOS DOCUMENTOS';

export const DELETE_NUMERO_UNICO_DOCUMENTO = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] DELETE NUMERO UNICO DOCUMENTO';
export const DELETE_NUMERO_UNICO_DOCUMENTO_SUCCESS = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] DELETE NUMERO UNICO DOCUMENTO SUCCESS';
export const DELETE_NUMERO_UNICO_DOCUMENTO_FAILED = '[ADMIN NUMEROS UNICOS DOCUMENTOS LIST] DELETE NUMERO UNICO DOCUMENTO FAILED';
