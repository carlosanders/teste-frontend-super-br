...
export class NumeroUnicoDocumentoEffects {
    ...
    getSetor: any =
        this._actions
            .pipe(
                ofType<NumeroUnicoDocumentoActions.GetSetor>(NumeroUnicoDocumentoActions.GET_SETOR),
                switchMap((action) => {
                ...
                switchMap(response => [
                    ...
                    new NumeroUnicoDocumentoActions.GetSetorSuccess({
                        loaded: {
                            id: 'setorHandle',
                ...
                catchError((err, caught) => {
                    console.log(err);
                    this._store.dispatch(new NumeroUnicoDocumentoActions.GetSetorFailed(err));
                    return caught;
                })
            );
}
