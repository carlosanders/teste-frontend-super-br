...
export const CREATE_NUMERO_UNICO_DOCUMENTO = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] CREATE NUMERO UNICO DOCUMENTO';
export const CREATE_NUMERO_UNICO_DOCUMENTO_SUCCESS = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] CREATE NUMERO UNICO DOCUMENTO SUCCESS';

export const SAVE_NUMERO_UNICO_DOCUMENTO = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] SAVE NUMERO UNICO DOCUMENTO';
export const SAVE_NUMERO_UNICO_DOCUMENTO_SUCCESS = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] SAVE NUMERO UNICO DOCUMENTO SUCCESS';
export const SAVE_NUMERO_UNICO_DOCUMENTO_FAILED = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] SAVE NUMERO UNICO DOCUMENTO FAILED';

export const GET_NUMERO_UNICO_DOCUMENTO = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] GET NUMERO UNICO DOCUMENTO';
export const GET_NUMERO_UNICO_DOCUMENTO_SUCCESS = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] GET NUMERO UNICO DOCUMENTO SUCCESS';
export const GET_NUMERO_UNICO_DOCUMENTO_FAILED = '[ADMIN NUMERO UNICO DOCUMENTO EDIT] GET NUMERO UNICO DOCUMENTO FAILED';
