...
@Component({
  selector: 'app-arquivista-classificacao',
  templateUrl: './arquivista-classificacao.component.html',
  styleUrls: ['./arquivista-classificacao.component.scss']
})
export class ArquivistaClassificacaoComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void {
        const path = 'app/main/apps/arquivista/arquivista-classificacao';
