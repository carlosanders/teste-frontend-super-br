...
export const CREATE_VINCULACAO_ETIQUETA = '[VINCULACAO ETIQUETA CREATE] CREATE VINCULACAO ETIQUETA';
export const CREATE_VINCULACAO_ETIQUETA_SUCCESS = '[VINCULACAO ETIQUETA CREATE] CREATE VINCULACAO ETIQUETA SUCCESS';

export const SAVE_VINCULACAO_ETIQUETA = '[VINCULACAO ETIQUETA CREATE] SAVE VINCULACAO ETIQUETA';
export const SAVE_VINCULACAO_ETIQUETA_SUCCESS = '[VINCULACAO ETIQUETA CREATE] SAVE VINCULACAO ETIQUETA SUCCESS';
export const SAVE_VINCULACAO_ETIQUETA_FAILED = '[VINCULACAO ETIQUETA CREATE] SAVE VINCULACAO ETIQUETA FAILED';
...
export type VinculacaoEtiquetaCreateActionsAll
