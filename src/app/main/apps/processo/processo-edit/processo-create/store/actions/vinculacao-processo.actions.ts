...
export const GET_VINCULACOES_PROCESSOS = '[DADOS BASICOS JUDICIAL STEPS] GET VINCULACOES PROCESSOS';
export const GET_VINCULACOES_PROCESSOS_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] GET VINCULACOES PROCESSOS SUCCESS';
export const GET_VINCULACOES_PROCESSOS_FAILED = '[DADOS BASICOS JUDICIAL STEPS] GET VINCULACOES PROCESSOS FAILED';

export const UNLOAD_VINCULACOES_PROCESSOS = '[DADOS BASICOS JUDICIAL STEPS] UNLOAD VINCULACOES PROCESSOS';
export const RELOAD_VINCULACOES_PROCESSOS = '[DADOS BASICOS JUDICIAL STEPS] RELOAD VINCULACOES PROCESSOS';

export const SAVE_VINCULACAO_PROCESSO = '[DADOS BASICOS JUDICIAL STEPS] SAVE VINCULACAO PROCESSO';
export const SAVE_VINCULACAO_PROCESSO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] SAVE VINCULACAO PROCESSO SUCCESS';
export const SAVE_VINCULACAO_PROCESSO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] SAVE VINCULACAO PROCESSO FAILED';

export const DELETE_VINCULACAO_PROCESSO = '[DADOS BASICOS JUDICIAL STEPS] DELETE VINCULACAO_PROCESSO';
export const DELETE_VINCULACAO_PROCESSO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] DELETE VINCULACAO_PROCESSO SUCCESS';
export const DELETE_VINCULACAO_PROCESSO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] DELETE VINCULACAO_PROCESSO FAILED';
