...
export const GET_JUNTADAS = '[DADOS BASICOS JUDICIAL STEPS] GET JUNTADAS';
export const GET_JUNTADAS_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] GET JUNTADAS SUCCESS';
export const GET_JUNTADAS_FAILED = '[DADOS BASICOS JUDICIAL STEPS] GET JUNTADAS FAILED';

export const UNLOAD_JUNTADAS = '[DADOS BASICOS JUDICIAL STEPS] UNLOAD JUNTADAS';
