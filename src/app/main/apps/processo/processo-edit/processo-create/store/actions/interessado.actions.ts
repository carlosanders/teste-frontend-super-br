...
export const GET_INTERESSADOS = '[DADOS BASICOS JUDICIAL STEPS] GET INTERESSADOS';
export const GET_INTERESSADOS_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] GET INTERESSADOS SUCCESS';
export const GET_INTERESSADOS_FAILED = '[DADOS BASICOS JUDICIAL STEPS] GET INTERESSADOS FAILED';

export const RELOAD_INTERESSADOS = '[DADOS BASICOS JUDICIAL STEPS] RELOAD INTERESSADOS';
export const UNLOAD_INTERESSADOS = '[DADOS BASICOS JUDICIAL STEPS] UNLOAD INTERESSADOS';

export const SAVE_INTERESSADO = '[DADOS BASICOS JUDICIAL STEPS] SAVE INTERESSADO';
export const SAVE_INTERESSADO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] SAVE INTERESSADO SUCCESS';
export const SAVE_INTERESSADO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] SAVE INTERESSADO FAILED';

export const DELETE_INTERESSADO = '[DADOS BASICOS JUDICIAL STEPS] DELETE INTERESSADO';
export const DELETE_INTERESSADO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] DELETE INTERESSADO SUCCESS';
export const DELETE_INTERESSADO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] DELETE INTERESSADO FAILED';
