...
export const GET_CONFIGURACOES_NUP = '[DADOS BASICOS JUDICIAL STEPS] GET CONFIGURACOES NUP';
export const GET_CONFIGURACOES_NUP_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] GET CONFIGURACOES NUP SUCCESS';
export const GET_CONFIGURACOES_NUP_FAILED = '[DADOS BASICOS JUDICIAL STEPS] GET CONFIGURACOES NUP FAILED';

export const RELOAD_CONFIGURACOES_NUP = '[DADOS BASICOS JUDICIAL STEPS] RELOAD CONFIGURACOES NUP';
export const UNLOAD_CONFIGURACOES_NUP = '[DADOS BASICOS JUDICIAL STEPS] UNLOAD CONFIGURACOES NUP';
