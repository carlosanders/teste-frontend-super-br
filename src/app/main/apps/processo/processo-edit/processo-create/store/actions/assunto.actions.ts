...
export const GET_ASSUNTOS = '[DADOS BASICOS JUDICIAL STEPS] GET ASSUNTOS';
export const GET_ASSUNTOS_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] GET ASSUNTOS SUCCESS';
export const GET_ASSUNTOS_FAILED = '[DADOS BASICOS JUDICIAL STEPS] GET ASSUNTOS FAILED';

export const RELOAD_ASSUNTOS = '[DADOS BASICOS JUDICIAL STEPS] RELOAD ASSUNTOS';
export const DELETE_ASSUNTO = '[DADOS BASICOS JUDICIAL STEPS] DELETE ASSUNTO';
export const DELETE_ASSUNTO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] DELETE ASSUNTO SUCCESS';
export const DELETE_ASSUNTO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] DELETE ASSUNTO FAILED';

export const SAVE_ASSUNTO = '[DADOS BASICOS JUDICIAL STEPS] SAVE ASSUNTO';
export const SAVE_ASSUNTO_SUCCESS = '[DADOS BASICOS JUDICIAL STEPS] SAVE ASSUNTO SUCCESS';
export const SAVE_ASSUNTO_FAILED = '[DADOS BASICOS JUDICIAL STEPS] SAVE ASSUNTO FAILED';

export const UNLOAD_ASSUNTOS = '[DADOS BASICOS JUDICIAL STEPS] UNLOAD ASSUNTOS';
