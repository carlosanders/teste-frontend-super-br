...
export const GET_VISIBILIDADES_DOCUMENTO = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADES';
export const GET_VISIBILIDADES_DOCUMENTO_SUCCESS = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADES SUCCESS';
export const GET_VISIBILIDADES_DOCUMENTO_FAILED = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADES FAILED';

export const RELOAD_VISIBILIDADES_DOCUMENTO = '[DOCUMENTO VISIBILIDADE] RELOAD VISIBILIDADES';

export const DELETE_VISIBILIDADE_DOCUMENTO = '[DOCUMENTO VISIBILIDADE] DELETE VISIBILIDADE';
export const DELETE_VISIBILIDADE_DOCUMENTO_SUCCESS = '[DOCUMENTO VISIBILIDADE] DELETE VISIBILIDADE SUCCESS';
export const DELETE_VISIBILIDADE_DOCUMENTO_FAILED = '[DOCUMENTO VISIBILIDADE] DELETE VISIBILIDADE FAILED';

export const GET_VISIBILIDADE_DOCUMENTO = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADE';
export const GET_VISIBILIDADE_DOCUMENTO_SUCCESS = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADE SUCCESS';
export const GET_VISIBILIDADE_DOCUMENTO_FAILED = '[DOCUMENTO VISIBILIDADE] GET VISIBILIDADE FAILED';

export const SAVE_VISIBILIDADE_DOCUMENTO = '[DOCUMENTO VISIBILIDADE] SAVE DOCUMENTO VISIBILIDADE';
export const SAVE_VISIBILIDADE_DOCUMENTO_SUCCESS = '[DOCUMENTO VISIBILIDADE] SAVE VISIBILIDADE DOCUMENTO SUCCESS';
export const SAVE_VISIBILIDADE_DOCUMENTO_FAILED = '[DOCUMENTO VISIBILIDADE] SAVE VISIBILIDADE DOCUMENTO FAILED';
