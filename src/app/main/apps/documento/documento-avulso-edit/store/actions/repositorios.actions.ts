...
export const GET_REPOSITORIOS = '[DOCUMENTO AVULSO EDIT] GET REPOSITORIOS';
export const GET_REPOSITORIOS_SUCCESS = '[DOCUMENTO AVULSO EDIT] GET REPOSITORIOS SUCCESS';
export const GET_REPOSITORIOS_FAILED = '[DOCUMENTO AVULSO EDIT] GET REPOSITORIOS FAILED';

export const SET_QUERY_REPOSITORIOS = '[DOCUMENTO AVULSO EDIT] SET QUERY REPOSITORIOS';
