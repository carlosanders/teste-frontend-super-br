...
import {DocumentoAvulsoEditAppState, getDocumentoAvulsoEditAppState, ComponenteDigitalState} from '../reducers';
...
export const getComponenteDigitalState = createSelector(
    ...
    (state: DocumentoAvulsoEditAppState) => state.componentesDigitais
);
