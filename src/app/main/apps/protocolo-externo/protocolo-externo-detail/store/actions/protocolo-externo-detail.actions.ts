...
export const GET_PROCESSO = '[PROCESSO DETAIL] GET PROCESSO';
export const GET_PROCESSO_SUCCESS = '[PROCESSO DETAIL] GET PROCESSO SUCCESS';
export const GET_PROCESSO_FAILED = '[PROCESSO DETAIL] GET PROCESSO FAILED';

export const EDIT_PROCESSO = '[PROCESSO DETAIL] EDIT PROCESSO';
export const EDIT_PROCESSO_SUCCESS = '[PROCESSO DETAIL] EDIT PROCESSO SUCCESS';

export const CREATE_PROCESSO = '[PROCESSO DETAIL] CREATE PROCESSO';
export const CREATE_PROCESSO_SUCCESS = '[PROCESSO DETAIL] CREATE PROCESSO SUCCESS';

export const SAVE_PROCESSO = '[PROCESSO DETAIL] SAVE PROCESSO';
export const SAVE_PROCESSO_SUCCESS = '[PROCESSO DETAIL] SAVE PROCESSO SUCCESS';
export const SAVE_PROCESSO_FAILED = '[PROCESSO DETAIL] SAVE PROCESSO FAILED';

export const DAR_CIENCIA_PROCESSO = '[PROCESSO DETAIL] DAR CIENCIA PROCESSO';
export const DAR_CIENCIA_PROCESSO_SUCCESS = '[PROCESSO DETAIL] DAR CIENCIA PROCESSO SUCCESS';
export const DAR_CIENCIA_PROCESSO_FAILED = '[PROCESSO DETAIL] DAR CIENCIA PROCESSO FAILED';

export const DELETE_PROCESSO = '[PROCESSO DETAIL] DELETE PROCESSO';
export const DELETE_PROCESSO_SUCCESS = '[PROCESSO DETAIL] DELETE PROCESSO SUCCESS';
export const DELETE_PROCESSO_FAILED = '[PROCESSO DETAIL] DELETE PROCESSO FAILED';

export const CREATE_VINCULACAO_ETIQUETA = '[PROCESSO DETAIL] VINCULACAO ETIQUETA';
export const CREATE_VINCULACAO_ETIQUETA_SUCCESS = '[PROCESSO DETAIL] VINCULACAO ETIQUETA SUCCESS';
export const CREATE_VINCULACAO_ETIQUETA_FAILED = '[PROCESSO DETAIL] VINCULACAO ETIQUETA FAILED';

export const SAVE_CONTEUDO_VINCULACAO_ETIQUETA = '[PROCESSO DETAIL] SAVE CONTEUDO VINCULACAO ETIQUETA';
export const SAVE_CONTEUDO_VINCULACAO_ETIQUETA_SUCCESS = '[PROCESSO DETAIL] SAVE CONTEUDO VINCULACAO ETIQUETA SUCCESS';
export const SAVE_CONTEUDO_VINCULACAO_ETIQUETA_FAILED = '[PROCESSO DETAIL] SAVE CONTEUDO VINCULACAO ETIQUETA FAILED';

export const DELETE_VINCULACAO_ETIQUETA = '[PROCESSO DETAIL] DELETE VINCULACAO_ETIQUETA';
export const DELETE_VINCULACAO_ETIQUETA_SUCCESS = '[PROCESSO DETAIL] DELETE VINCULACAO_ETIQUETA SUCCESS';
export const DELETE_VINCULACAO_ETIQUETA_FAILED = '[PROCESSO DETAIL] DELETE VINCULACAO_ETIQUETA FAILED';

export const GET_DOCUMENTOS = '[PROCESSO DETAIL] GET DOCUMENTOS';
export const GET_DOCUMENTOS_SUCCESS = '[PROCESSO DETAIL] GET DOCUMENTOS SUCCESS';
export const GET_DOCUMENTOS_FAILED = '[PROCESSO DETAIL] GET DOCUMENTOS FAILED';

export const DESELECT_PROCESSO_ACTION = '[PROCESSO DETAIL] DESELECT PROCESSO ACTION';
